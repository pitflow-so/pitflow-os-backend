...
public class JpaServiceOrderRepositoryAdapter implements ServiceOrderRepository {

    private final SpringServiceOrderRepository springRepository;

    public JpaServiceOrderRepositoryAdapter(SpringServiceOrderRepository springRepository) {
